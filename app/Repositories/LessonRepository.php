...
class LessonRepository
{
    ...
    public function updatedLessonByUuid(int $moduleId, string $identify, array $data)
    {
    ...
    {
        return $this->entity->where('module_id', $moduleId)->where('uuid', $identify)->firstOrFail();
    }
