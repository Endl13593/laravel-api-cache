...
class ModuleRepository
{
    ...
    public function updatedModuleByUuid(int $courseId, string $identify, array $data)
    {
    ...
    {
        return $this->entity->where('course_id', $courseId)->where('uuid', $identify)->firstOrFail();
    }
